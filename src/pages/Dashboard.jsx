...
import { SparklineAreaData, dropdownData, medicalproBranding, recentTransactions, weeklyStats } from '../data/dummy';
    ...
    <div className="mt-24">
      <div className="flex flex-wrap lg:flex-nowrap justify-center ">
        ...
        <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
            ...
            <div key='Leak-Detects' className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56  p-4 pt-9 rounded-2xl ">
              <button
                type="button"
              ...
              <p className="mt-3">
                <span className="text-lg font-semibold">{variable4Value}</span>
            ...
            <div key='Fraud-Detects' className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56  p-4 pt-9 rounded-2xl ">
              <button
                type="button"
                style={{ color: '#03C9D7', backgroundColor: '#E5FAFB' }}
                className="text-2xl opacity-0.9 rounded-full  p-4 hover:drop-shadow-xl"
              ...
              <p className="mt-3">
                <span className="text-lg font-semibold">{variable3Value}</span>
                <span className={`text-sm text-${'green-600'} ml-2`}>
                  {/* {item.percentage} */}
                </span>
              </p>
            ...
            <div key='Reported Complains' className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56  p-4 pt-9 rounded-2xl ">
              <button
                type="button"
                style={{ color: '#03C9D7', backgroundColor: '#E5FAFB' }}
                className="text-2xl opacity-0.9 rounded-full  p-4 hover:drop-shadow-xl"
              ...
              <p className="mt-3">
                <span className="text-lg font-semibold">{variable5Value}</span>
                <span className={`text-sm text-${'green-600'} ml-2`}>
                  {/* {item.percentage} */}
                </span>
              </p>
              <p className="text-sm text-gray-400  mt-1">Reported Complains</p>
            </div>


            <div key='Active Sensors' className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56  p-4 pt-9 rounded-2xl ">
              <button
                type="button"
                style={{ color: '#03C9D7', backgroundColor: '#E5FAFB' }}
                className="text-2xl opacity-0.9 rounded-full  p-4 hover:drop-shadow-xl"
              ...
              <p className="mt-3">
                <span className="text-lg font-semibold">{variable2Value}</span>
                <span className={`text-sm text-${'green-600'} ml-2`}>
                  {/* {item.percentage} */}
                </span>
              </p>
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        {/* <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780  ">
          <div className="flex justify-between">
            <p className="font-semibold text-xl">Ongoing Maintaince</p>
        ...
        <div>
          ...
          >
            <div className="flex justify-between items-center ">
              ...
              <div>
                <p className="text-2xl text-white font-semibold mt-8">63,448.78 liters</p>
      ...
      <div className="flex gap-10 m-4 flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 rounded-2xl">
          <div className="flex justify-between items-center gap-2">
            <p className="text-xl font-semibold">Recent Alerts</p>
